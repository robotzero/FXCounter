...
public class TickingTest extends CounterAppIT {
    ...
    public void ticking() {
        ...
        // Prepare clock state;
        repository.create("start", LocalTime.of(12, 10, 1));
        ...
        try {
            WaitFor.waitUntil(timeout(millis(1300)));
        ...
        verifyThat("#paneSeconds", (StackPane s) -> {
            ...
            if (exTopRectangle.isPresent() && exBottomRectangle.isPresent()) {
                ...
                return exTopRectangle.get().getParent().getParent().getTranslateY() == 0
                        && labelTop.equals("02")
                        && exBottomRectangle.get().getParent().getParent().getTranslateY() == 2 * height
                        && labelBottom.equals("00");
            }
