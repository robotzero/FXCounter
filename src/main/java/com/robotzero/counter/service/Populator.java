...
public class Populator {
  ...
  private final Function<ColumnType, Predicate<Node>> nodeTypePredicateFactory =
    (
      columnType -> {
  ...
  public Map<ColumnType, Column> timerColumns(GridPane gridPane) {
    return gridPane
      ...
      .filtered(
        nodeClassPredicateFactory
          .apply(StackPane.class)
          .and(
            nodeTypePredicateFactory
              .apply(ColumnType.SECONDS)
